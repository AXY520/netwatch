(function () {
    ...
    var dict = {
        "zh-CN": {
            ...
            "first_loading": "首次加载",
            "refreshing": "正在刷新",
            "last_success_prefix": "上次 ",
            "data_stale": "数据可能已过期",
            "capability_unsupported": "当前环境不支持",
            "sites_unit": " 个网站",
            "ports_unit": " 个端口",
            "apps_unit": " 个应用",
            "interfaces_unit": " 个接口",
			...
			"network_mutation_verification": "变更后验证",
			"network_verify_interface_exists": "目标接口",
			"network_verify_link_up": "链路状态",
			"network_verify_runtime_config": "运行时配置",
			"network_verify_ipv4_address": "IPv4 地址",
			"network_verify_default_gateway": "默认网关",
			"network_verify_gateway_reachable": "网关可达性",
			"network_verify_dns_config": "DNS 配置",
			"network_verify_dns_resolution": "DNS 解析",
			"network_verify_domestic_connectivity": "国内连通性",
			"network_verify_global_connectivity": "国际连通性",
			"network_verify_lazycat_system_api": "懒猫系统接口",
            ...
            "events_page_title": "NETWATCH // 网络事件中心",
            "events_page_subtitle": "网络变化与配置操作记录",
            "events_center_btn": "事件中心",
            "events_all_severities": "全部级别",
            "events_warning": "警告",
            "events_info": "信息",
            "events_all_kinds": "全部类型",
            "events_range_7d": "7 天",
            "events_range_30d": "30 天",
            "events_empty": "当前筛选范围内没有事件",
            "events_count_unit": "条事件",
            "event_source_network_observer": "网络观测",
            "event_source_network_control": "网络控制",
            "event_source_app_traffic_observer": "应用流量观测",
            "event_kind_egress_ipv4_changed": "出口 IPv4 变化",
            "event_kind_egress_ipv6_changed": "出口 IPv6 变化",
            "event_kind_default_ipv4_gateway_changed": "IPv4 默认网关变化",
            "event_kind_default_ipv6_gateway_changed": "IPv6 默认网关变化",
            "event_kind_domestic_connectivity_changed": "国内连通性变化",
            "event_kind_global_connectivity_changed": "国际连通性变化",
            "event_kind_nat_type_changed": "NAT 类型变化",
            "event_kind_nat_reachability_changed": "NAT 可达性变化",
            "event_kind_interface_state_changed": "网卡状态变化",
            "event_kind_ipv6_prefix_changed": "IPv6 前缀变化",
            "event_kind_app_bridge_appeared": "应用网桥出现",
            "event_kind_app_bridge_disappeared": "应用网桥消失",
            "event_kind_app_traffic_high": "应用高流量",
            "dns_diag_page_title": "NETWATCH // DNS 诊断",
            "dns_diag_page_subtitle": "系统 DNS 与指定服务器对比",
            "dns_diag_btn": "DNS 诊断",
            "dns_diag_domain": "域名",
            "dns_diag_record_type": "记录类型",
            "dns_diag_server": "对比服务器",
            "dns_diag_run": "查询",
            "dns_diag_idle": "等待查询",
            "dns_diag_running": "DNS 查询中",
            "dns_diag_failed": "DNS 查询失败",
            "dns_diag_system": "系统 DNS",
            "dns_diag_specified": "指定 DNS",
            "dns_diag_no_answers": "响应成功，但没有返回此类型的记录",
            "dns_diag_value": "记录值",
            "dns_diag_same": "两侧响应一致",
            "dns_diag_different": "两侧响应存在差异",
            "dns_diff_status": "响应状态",
            "dns_diff_dnssec": "DNSSEC 信号",
            "dns_diff_answers": "记录值",
            "dnssec_authenticated_data": "AD 已认证",
            "dnssec_signatures_present_unvalidated": "存在签名，未本地验证",
            "dnssec_not_present": "未发现 DNSSEC 签名",
            "dns_error_timeout": "查询超时",
            "dns_error_network_unreachable": "网络不可达",
            "dns_error_connection_refused": "连接被拒绝",
            "dns_error_invalid_response": "响应无效",
            "dns_error_query_failed": "查询失败",
            "downloading": "正在下载",
            "uploading": "正在上传",
        ...
        "en": {
            ...
            "waiting": "Waiting",
            "loading": "Loading...",
            "first_loading": "Initial load",
            "refreshing": "Refreshing",
            "last_success_prefix": "Last ",
            "data_stale": "Data may be stale",
            "capability_unsupported": "Unsupported in this environment",
            "sites_unit": " sites",
            "ports_unit": " ports",
            "apps_unit": " apps",
            "interfaces_unit": " interfaces",
			...
			"network_mutation_verification": "Post-change verification",
			"network_verify_interface_exists": "Target interface",
			"network_verify_link_up": "Link state",
			"network_verify_runtime_config": "Runtime configuration",
			"network_verify_ipv4_address": "IPv4 address",
			"network_verify_default_gateway": "Default gateway",
			"network_verify_gateway_reachable": "Gateway reachability",
			"network_verify_dns_config": "DNS configuration",
			"network_verify_dns_resolution": "DNS resolution",
			"network_verify_domestic_connectivity": "Domestic connectivity",
			"network_verify_global_connectivity": "Global connectivity",
			"network_verify_lazycat_system_api": "Lazycat system API",
            ...
            "service_restart": "Service restart boundary",
            ...
            "events_page_title": "NETWATCH // Network Events",
            "events_page_subtitle": "Network changes and configuration operations",
            "events_center_btn": "Events",
            "events_all_severities": "All severities",
            "events_warning": "Warning",
            "events_info": "Info",
            "events_all_kinds": "All event types",
            "events_range_7d": "7 days",
            "events_range_30d": "30 days",
            "events_empty": "No events in the selected range",
            "events_count_unit": "events",
            "event_source_network_observer": "Network observer",
            "event_source_network_control": "Network control",
            "event_source_app_traffic_observer": "Application traffic observer",
            "event_kind_egress_ipv4_changed": "Egress IPv4 changed",
            "event_kind_egress_ipv6_changed": "Egress IPv6 changed",
            "event_kind_default_ipv4_gateway_changed": "IPv4 gateway changed",
            "event_kind_default_ipv6_gateway_changed": "IPv6 gateway changed",
            "event_kind_domestic_connectivity_changed": "Domestic connectivity changed",
            "event_kind_global_connectivity_changed": "Global connectivity changed",
            "event_kind_nat_type_changed": "NAT type changed",
            "event_kind_nat_reachability_changed": "NAT reachability changed",
            "event_kind_interface_state_changed": "Interface state changed",
            "event_kind_ipv6_prefix_changed": "IPv6 prefix changed",
            "event_kind_app_bridge_appeared": "Application bridge appeared",
            "event_kind_app_bridge_disappeared": "Application bridge disappeared",
            "event_kind_app_traffic_high": "High application traffic",
            "dns_diag_page_title": "NETWATCH // DNS Diagnostics",
            "dns_diag_page_subtitle": "Compare system DNS with a specified resolver",
            "dns_diag_btn": "DNS Diagnostics",
            "dns_diag_domain": "Domain",
            "dns_diag_record_type": "Record type",
            "dns_diag_server": "Compare resolver",
            "dns_diag_run": "Query",
            "dns_diag_idle": "Waiting for query",
            "dns_diag_running": "Querying DNS",
            "dns_diag_failed": "DNS query failed",
            "dns_diag_system": "System DNS",
            "dns_diag_specified": "Specified DNS",
            "dns_diag_no_answers": "The response succeeded but returned no records of this type",
            "dns_diag_value": "Record value",
            "dns_diag_same": "Both responses match",
            "dns_diag_different": "The responses differ",
            "dns_diff_status": "response status",
            "dns_diff_dnssec": "DNSSEC signal",
            "dns_diff_answers": "record values",
            "dnssec_authenticated_data": "Authenticated data",
            "dnssec_signatures_present_unvalidated": "Signatures present, not locally validated",
            "dnssec_not_present": "No DNSSEC signatures found",
            "dns_error_timeout": "Query timed out",
            "dns_error_network_unreachable": "Network unreachable",
            "dns_error_connection_refused": "Connection refused",
            "dns_error_invalid_response": "Invalid response",
            "dns_error_query_failed": "Query failed",
