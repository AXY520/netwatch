(function () {
    ...
    var dict = {
        "zh-CN": {
            ...
            "iface_col": "接口",
            "link_speed_col": "协商速率",
            "wifi_link_speed_title": "当前 Wi-Fi 物理层速率",
            "wifi_link_speed_receive": "接收",
            "wifi_link_speed_transmit": "发送",
            "ipv4_col": "IPv4 地址",
            "ipv6_col": "IPv6 地址",
            ...
            "network_config_note": "变更未确认会自动回滚",
            "network_config_device": "网卡",
            "network_config_method": "配置方式",
            "network_config_method_auto": "自动获取",
            "network_config_method_manual": "手动配置",
            "network_config_mac": "MAC 地址",
            "network_config_mac_invalid": "请输入 MAC 地址",
            "network_mac_current": "当前 MAC",
            "network_mac_original": "原始硬件 MAC",
            "network_mac_new": "新 MAC",
            "network_mac_apply": "应用 MAC",
            "network_mac_restore": "恢复原始 MAC",
            "network_mac_apply_confirm": "修改 MAC 会短暂中断该网卡连接。应用后 3 分钟内必须确认，否则自动回滚。继续？",
            "network_mac_restore_confirm": "将 MAC 恢复为原始硬件地址 {mac}。连接会短暂中断，继续？",
            "network_mac_applying": "正在应用 MAC...",
            "network_mac_original_unavailable": "该设备未提供原始硬件 MAC，无法自动恢复",
			...
			"network_verify_mac_address": "MAC 地址",
            ...
            "current_total": "当前总量",
            "history_title": "历史记录",
            "broadband_history_title": "宽带测速历史",
            "transfer_history_title": "传输测速历史",
            "settings_btn": "设置",
            "broadband_btn": "宽带测速",
            "transfer_btn": "传输测速",
            ...
            "start_test_btn": "开始测速",
            "save_btn": "保存",
            "speed_history_note": "备注",
            "speed_history_add_note": "添加备注",
            "speed_history_note_placeholder": "输入本次测速备注",
            "clear_history_btn": "清除历史记录",
            "clear_history_title": "清除测速历史",
            "clear_history_confirm": "确定清除当前测速窗口的全部历史记录吗？此操作不可撤销。",
            "clear_btn": "清除",
            "clear_failed": "清除历史记录失败",
            "close_btn": "关闭",
            "page_title": "NETWATCH // 微服网络诊断",
            ...
            "app_col": "应用名",
            "app_traffic_realtime": "实时",
            "app_traffic_today": "今日",
            "app_traffic_month": "本月",
            "app_traffic_limit": "限制网速",
            "app_traffic_limit_status": "限速",
            "app_traffic_unlimited": "不限速",
            "app_traffic_upload_limit": "上传上限 (Mbps)",
            "app_traffic_download_limit": "下载上限 (Mbps)",
            "app_traffic_limit_hint": "留空或 0 为不限速",
            "app_traffic_limit_placeholder": "0 = 不限速",
            "app_traffic_limit_invalid": "请输入 0 至 10000 之间的有效值",
            "app_traffic_limit_saved": "应用网速限制已保存",
            "app_traffic_actions": "操作",
            "app_traffic_more": "更多操作",
            "app_traffic_realtime_monitor": "应用流量实时刷新",
            "app_connections_title": "连接明细",
            "app_connections_loading": "正在读取连接…",
            "app_connections_live": "实时快照",
            "app_connections_paused": "已暂停刷新",
            "app_connections_pause_refresh": "暂停自动刷新",
            "app_connections_resume_refresh": "继续自动刷新",
            "app_connections_protocol": "协议",
            "app_connections_local": "本地端点",
            "app_connections_remote": "远程目标",
            "app_connections_domain": "域名",
            "app_connections_service": "服务",
            "app_connections_count": "条连接",
            "app_connections_truncated": "已达显示上限",
            "app_connections_inbound": "入站",
            "app_connections_outbound": "出站",
            "app_connections_direction_unknown": "方向未知",
            "app_connections_unavailable": "当前环境无法提供连接明细",
            "app_connections_empty": "当前没有活动的远程连接",
            "app_connections_failed": "连接明细读取失败",
            "host_network_experimental": "Host 网络控制（实验性）",
            "app_traffic_disable_internet": "禁用外网",
            "app_traffic_restore_internet": "恢复外网",
            "app_traffic_internet_disabled": "外网已禁用",
            "app_traffic_internet_disabled_status": "禁用外网",
            "app_traffic_internet_policy_drifted": "外网策略异常",
			"app_traffic_network_updated": "应用外网访问已更新",
			"app_proxy_protocol": "代理类型",
			"app_proxy_host": "代理 IP",
			"app_proxy_port": "代理端口",
			"app_proxy_invalid": "请输入有效的代理 IP 和端口",
			"app_proxy_set": "设置代理",
			"app_proxy_save_enable": "启用",
			"app_proxy_restore_direct": "恢复直连",
			"app_proxy_updated": "应用代理设置已更新",
			"app_proxy_status": "代理",
			"app_proxy_paused_status": "代理暂停",
			"app_proxy_enabled": "应用流量正通过代理转发",
			"app_proxy_paused": "外网已禁用，应用代理暂时停用",
            "settings_window_title": "设置",
            "broadband_window_title": "宽带测速",
            "broadband_mode_client": "客户端-公网",
            "broadband_mode_server": "微服端-公网",
            "broadband_mode_port_policy": "端口限速检测",
            ...
            "broadband_port_policy_low": "低位端口",
            "broadband_port_policy_high": "高位端口",
            "broadband_port_policy_allocating": "正在申请公网高低端口",
            "broadband_port_policy_running": "正在进行端口策略测速",
            "broadband_port_policy_high_failed": "高位端口无法完成测速",
            "broadband_port_policy_low_failed": "低位端口无法完成测速",
            "broadband_port_policy_likely_limited": "高位端口速度明显低于低位端口，可能存在端口策略限制",
            "broadband_port_policy_no_obvious_limit": "高低端口速度暂无明显差异",
            ...
            "events_search_placeholder": "搜索事件、设备或状态",
            "events_warning": "警告",
            "events_info": "信息",
            ...
            "event_kind_app_enabled": "应用启用",
            "event_kind_app_disabled": "应用停用",
            "event_kind_app_traffic_high": "应用高流量",
            "event_kind_network_mutation_pending": "网络配置等待确认",
            "event_kind_network_mutation_confirmed": "网络配置已确认",
            "event_kind_network_mutation_rolling_back": "网络配置正在回滚",
            "event_kind_network_mutation_rolled_back": "网络配置已回滚",
            "event_kind_network_mutation_failed": "网络配置操作失败",
            "event_network_mutation_title": "网络配置操作：",
            "network_mutation_kind_ip": "网卡配置",
            "network_mutation_kind_bridge": "网桥",
            "network_mutation_kind_dns": "DNS",
            "network_mutation_state_preparing": "正在准备",
            "network_mutation_state_pending": "等待确认",
            "network_mutation_state_confirmed": "已确认",
            "network_mutation_state_rolling_back": "正在回滚",
            "network_mutation_state_rolled_back": "已回滚",
            "network_mutation_state_failed": "失败",
            "dns_diag_page_title": "NETWATCH // DNS 诊断",
            "dns_diag_page_subtitle": "真实网卡 DNS 查询与解析对比",
            "dns_diag_btn": "DNS 诊断",
            "dns_diag_domain": "域名",
            ...
            "dns_diag_active_resolvers": "当前网卡 DNS",
            "dns_diag_loading_resolvers": "正在读取真实网卡 DNS",
            "dns_diag_device": "网卡",
            "dns_diag_connection": "连接",
            "dns_diag_notice": "说明",
            "dns_diag_unavailable": "不可用",
            "dns_diag_system_group": "真实网卡 DNS",
            "dns_diag_specified_group": "对比 DNS",
            "dns_diag_resolver": "解析器",
            "dns_diag_select_device": "诊断网卡",
            "dns_diag_auto_device": "自动选择",
            "dns_diag_link_type": "链路类型",
            "dns_diag_latency": "响应耗时",
            "dns_diag_transport": "传输协议",
            "dns_diag_server_address": "DNS 服务器",
            "dns_source_lazycat_sdk": "懒猫 SDK",
            "dns_source_networkmanager": "NetworkManager",
            "dns_source_container_resolv_conf": "容器回退",
            "dns_source_unknown": "来源未知",
            "dns_conclusion_system_ok": "真实网卡配置的 DNS 均可正常解析，并返回了目标记录。",
            "dns_conclusion_system_partial": "部分真实网卡 DNS 查询失败，请检查主、备用 DNS 的连通性和配置。",
            "dns_conclusion_system_failed": "真实网卡配置的 DNS 均未能完成查询。",
            "dns_conclusion_specified_only_ok": "真实网卡 DNS 查询失败，但对比 DNS 正常，问题更可能出在当前 DNS 配置或其网络路径。",
            "dns_conclusion_responses_differ": "真实网卡 DNS 与对比 DNS 的响应存在差异，请结合状态、记录值和 DNSSEC 信号判断。",
            "dns_conclusion_no_answers": "DNS 查询成功，但没有返回所选类型的记录。",
            "downloading": "正在下载",
            "uploading": "正在上传",
        ...
        "en": {
            ...
            "latency_col": "Latency",
            "iface_col": "Interface",
            "link_speed_col": "Link Speed",
            "wifi_link_speed_title": "Current Wi-Fi PHY rate",
            "wifi_link_speed_receive": "Receive",
            "wifi_link_speed_transmit": "Transmit",
            ...
            "network_config_note": "Unconfirmed changes roll back automatically.",
            ...
            "network_config_mac": "MAC Address",
            "network_config_mac_invalid": "Enter a MAC address",
            "network_mac_current": "Current MAC",
            "network_mac_original": "Permanent hardware MAC",
            "network_mac_new": "New MAC",
            "network_mac_apply": "Apply MAC",
            "network_mac_restore": "Restore Original MAC",
            "network_mac_apply_confirm": "Changing the MAC briefly interrupts this interface. Confirm within 3 minutes or it rolls back automatically. Continue?",
            "network_mac_restore_confirm": "Restore the permanent hardware MAC {mac}? The connection will briefly disconnect.",
            "network_mac_applying": "Applying MAC...",
            "network_mac_original_unavailable": "This device does not expose a permanent hardware MAC",
            "network_config_address": "IPv4/CIDR",
			...
			"network_verify_mac_address": "MAC address",
            ...
            "broadband_history_title": "Broadband history",
            ...
            "save_btn": "Save",
            "speed_history_note": "Note",
            "speed_history_add_note": "Add note",
            "speed_history_note_placeholder": "Add a note for this test",
            "clear_history_btn": "Clear history",
            "clear_history_title": "Clear speed test history",
            "clear_history_confirm": "Clear all history in this speed test window? This cannot be undone.",
            "clear_btn": "Clear",
            ...
            "app_traffic_realtime": "Live",
            "app_traffic_today": "Today",
            "app_traffic_month": "This month",
            "app_traffic_limit": "Bandwidth limit",
            "app_traffic_limit_status": "Limited",
            "app_traffic_unlimited": "Unlimited",
            "app_traffic_upload_limit": "Upload limit (Mbps)",
            "app_traffic_download_limit": "Download limit (Mbps)",
            "app_traffic_limit_hint": "Leave blank or use 0 for unlimited",
            "app_traffic_limit_placeholder": "0 = unlimited",
            "app_traffic_limit_invalid": "Enter a valid value from 0 to 10000",
            "app_traffic_limit_saved": "Application limit saved",
            "app_traffic_actions": "Actions",
            "app_traffic_more": "More actions",
            "app_traffic_realtime_monitor": "Live app traffic refresh",
            "app_connections_title": "Connection details",
            "app_connections_loading": "Reading connections…",
            "app_connections_live": "Live snapshot",
            "app_connections_paused": "Refresh paused",
            "app_connections_pause_refresh": "Pause automatic refresh",
            "app_connections_resume_refresh": "Resume automatic refresh",
            "app_connections_protocol": "Protocol",
            "app_connections_local": "Local endpoint",
            "app_connections_remote": "Remote target",
            "app_connections_domain": "Domain",
            "app_connections_service": "Service",
            "app_connections_count": "connections",
            "app_connections_truncated": "display limit reached",
            "app_connections_inbound": "Inbound",
            "app_connections_outbound": "Outbound",
            "app_connections_direction_unknown": "Direction unknown",
            "app_connections_unavailable": "Connection details are unavailable in this environment",
            "app_connections_empty": "No active remote connections",
            "app_connections_failed": "Failed to read connection details",
            "host_network_experimental": "Host network controls (experimental)",
            "app_traffic_disable_internet": "Disable internet",
            "app_traffic_restore_internet": "Restore internet",
            "app_traffic_internet_disabled": "Internet disabled",
            "app_traffic_internet_disabled_status": "Internet blocked",
			"app_traffic_internet_policy_drifted": "Internet policy drift",
			"app_traffic_network_updated": "Application internet access updated",
			"app_proxy_protocol": "Proxy protocol",
			"app_proxy_host": "Proxy IP",
			"app_proxy_port": "Proxy port",
			"app_proxy_invalid": "Enter a valid proxy IP and port",
			"app_proxy_set": "Set proxy",
			"app_proxy_save_enable": "Enable",
			"app_proxy_restore_direct": "Restore direct",
			"app_proxy_updated": "Application proxy updated",
			"app_proxy_status": "Proxy",
			"app_proxy_paused_status": "Proxy paused",
			"app_proxy_enabled": "Application traffic is routed through the proxy",
			"app_proxy_paused": "Internet access is disabled, so the application proxy is paused",
            ...
            "broadband_mode_port_policy": "Public Port Policy",
            ...
            "broadband_port_policy_low": "Lower port",
            "broadband_port_policy_high": "Higher port",
            "broadband_port_policy_allocating": "Requesting public lower and higher ports",
            "broadband_port_policy_running": "Running port policy test",
            "broadband_port_policy_high_failed": "The higher port could not complete the test",
            "broadband_port_policy_low_failed": "The lower port could not complete the test",
            "broadband_port_policy_likely_limited": "The higher port is substantially slower; port policy limiting is possible",
            "broadband_port_policy_no_obvious_limit": "No obvious speed difference between the ports",
            ...
            "events_search_placeholder": "Search events, devices, or status",
            ...
            "event_kind_app_enabled": "Application enabled",
            "event_kind_app_disabled": "Application disabled",
            "event_kind_app_traffic_high": "High application traffic",
            "event_kind_network_mutation_pending": "Network configuration pending",
            "event_kind_network_mutation_confirmed": "Network configuration confirmed",
            "event_kind_network_mutation_rolling_back": "Network configuration rolling back",
            "event_kind_network_mutation_rolled_back": "Network configuration rolled back",
            "event_kind_network_mutation_failed": "Network configuration failed",
            "event_network_mutation_title": "Network configuration: ",
            "network_mutation_kind_ip": "Interface",
            "network_mutation_kind_bridge": "Bridge",
            "network_mutation_kind_dns": "DNS",
            "network_mutation_state_preparing": "Preparing",
            "network_mutation_state_pending": "Pending confirmation",
            "network_mutation_state_confirmed": "Confirmed",
            "network_mutation_state_rolling_back": "Rolling back",
            "network_mutation_state_rolled_back": "Rolled back",
            "network_mutation_state_failed": "Failed",
            "dns_diag_page_title": "NETWATCH // DNS Diagnostics",
            "dns_diag_page_subtitle": "Query real interface DNS and compare resolution",
            ...
            "dns_diag_active_resolvers": "Active interface DNS",
            "dns_diag_loading_resolvers": "Reading real interface DNS",
            "dns_diag_device": "Device",
            "dns_diag_connection": "Connection",
            "dns_diag_notice": "Notice",
            "dns_diag_unavailable": "Unavailable",
            "dns_diag_system_group": "Real interface DNS",
            "dns_diag_specified_group": "Comparison DNS",
            "dns_diag_resolver": "Resolver",
            "dns_diag_select_device": "Diagnostic interface",
            "dns_diag_auto_device": "Automatic",
            "dns_diag_link_type": "Link type",
            "dns_diag_latency": "Latency",
            "dns_diag_transport": "Transport",
            "dns_diag_server_address": "DNS server",
            "dns_source_lazycat_sdk": "Lazycat SDK",
            "dns_source_networkmanager": "NetworkManager",
            "dns_source_container_resolv_conf": "Container fallback",
            "dns_source_unknown": "Unknown source",
            "dns_conclusion_system_ok": "All DNS resolvers configured on the real interface resolved the requested record successfully.",
            "dns_conclusion_system_partial": "Some interface DNS queries failed. Check the connectivity and configuration of primary and backup resolvers.",
            "dns_conclusion_system_failed": "All DNS resolvers configured on the real interface failed to complete the query.",
            "dns_conclusion_specified_only_ok": "Interface DNS failed while the comparison resolver worked, indicating a likely configuration or network-path issue.",
            "dns_conclusion_responses_differ": "The interface and comparison DNS responses differ. Review status, values, and DNSSEC signals.",
            "dns_conclusion_no_answers": "The DNS query succeeded but returned no records of the selected type.",
