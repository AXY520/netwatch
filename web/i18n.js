(function () {
    ...
    var dict = {
        "zh-CN": {
            ...
            "port_not_occupied": "当前采样中未发现该端口占用",
            "port_search_invalid": "请输入 1-65535 的端口号",
            "min_rtt": "最小",
            "avg_rtt": "平均",
            "max_rtt": "最大",
            "latency_jitter": "抖动",
        ...
        "en": {
            ...
            "port_not_occupied": "This port is not occupied in the current sample",
            "port_search_invalid": "Enter a port number from 1 to 65535",
            "min_rtt": "Min",
            "avg_rtt": "Avg",
            "max_rtt": "Max",
